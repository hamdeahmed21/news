                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('store.post') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="exampleSelectGender" name="category_id">
                                    ...
                                    @foreach($category as $row)
                                        <option value="{{ $row->id }}">{{ $row->category_ar  }} | {{ $row->category_en  }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="exampleSelectGender" name="district_id">
                                    ...
                                    @foreach($district as $row)
                                        <option value="{{ $row->id }}">{{ $row->district_ar  }} | {{ $row-> district_en  }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="details_ar" id="summernote"></textarea>
                        </div>
