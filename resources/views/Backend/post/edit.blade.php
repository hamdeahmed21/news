...
@section('admin')
    ...
    @php
        $sub = DB::table('subcategories')->where('category_id',$post->category_id)->get();
          ...
          $subdist = DB::table('subdisctricts')->where('district_id',$post->district_id)->get();
    @endphp
                    ...
                    <form class="forms-sample" action="{{ route('update.post',$post->id ) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1" name=" title_ar" value="{{ $post->title_ar }}">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1" name="tags_ar" value="{{ $post->tags_ar }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="details_ar" id="summernote">
     {{ $post->details_ar }}
