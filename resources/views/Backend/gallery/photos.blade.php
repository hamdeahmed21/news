                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($photo as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('edit.gallery',$row->id) }}" class="btn btn-info">Edit</a>
                                        <a href="{{ route('delete.gallery',$row->id) }}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger">Delete</a>
