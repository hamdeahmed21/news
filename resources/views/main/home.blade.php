...
<section class="news-section">
    <div class="container-fluid">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="bg-one">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="top-news">
                                <a href="#"><img src="{{asset('assets/img/news.jpg")}}" alt="Notebook"></a>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="add"><img src="{{asset('assets/img/top-ad.jpg')}}" alt="" /></div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="add"><img src="{{asset('assets/img/top-ad.jpg')}}" alt="" /></div>
            </div>
                    ...
                    <div class="col-md-8 col-sm-8">
                        <div class="photo_screen">
                            <div class="myPhotos" style="width:100%">
                                <img src="{{asset('assets/img/news.jpg')}}"  alt="Avatar">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="photo_list_bg">
                            ...
                            <div class="photo_img photo_border active">
                                <img src="{{asset('assets/img/news.jpg')}}" alt="image" onclick="currentDiv(1)">
